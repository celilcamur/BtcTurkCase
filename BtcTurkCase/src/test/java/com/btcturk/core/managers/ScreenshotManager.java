package com.btcturk.core.managers;

import com.btcturk.utils.helpers.RandomNumberHelper;
...
public class ScreenshotManager {
    ...
    public static void saveFailScenarioScreenshot(WebDriver driver, Scenario scenario) throws IOException {
        String path = String.format(FAIL_SCENARIO_PATH, scenario.getName() + RandomNumberHelper.getNumber());
